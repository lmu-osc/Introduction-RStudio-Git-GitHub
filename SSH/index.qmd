...
Within this config file, we will need to add some lines specifying the host (GitHub) and the identity file (your private key). To do this, simply run the following command to insert the lines into the config file:
